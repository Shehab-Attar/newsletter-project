...
const Modal = ({
  ...
  // Determine margin based on language
  const otpContainerStyle = {
    marginRight: i18n.language === "ar" ? "200px" : "0",
    marginLeft: i18n.language === "ar" ? "0" : "200px",
  };

  return (
    showModal && (
      <div className="modal show" tabIndex={-1} onClick={handleClose}>
                  ...
                  <div className="col-lg-8 col-md-7 mb-0">
                    {!verificationID ? (
                      ...
                      >
                        ...
                        />
                        <button
                          className="btn btn-primary subscribe ms-2"
                      ...
                      <div
                        className="otp-container text-center"
                        style={{ alignItems: "center", ...otpContainerStyle }}
                      >
                        ...
                        <div className="d-flex justify-content-center otp-inputs">
                          {pasteOtp?.map((data, i) => (
                            <React.Fragment key={i}>
                              ...
                              />
                              {i < pasteOtp.length - 1 && (
                                <span className="otp-separator mt-2">
                                  &nbsp;-&nbsp;
                                </span>
                              )}
                            </React.Fragment>
